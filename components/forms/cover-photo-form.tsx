...
} from '@/store/action/accountAction'
import { ImageInitialValue } from '@/utils/validation/initialValues'
import toast from 'react-hot-toast'

export default function CoverPhotoForm({ initialValue, callback }: ProfileImageFormProps) {
  const [updateProfileImage, { isLoading }] = useUpdateCoverImageMutation()
